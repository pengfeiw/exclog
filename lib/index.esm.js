...
var logError = function () {
    ...
    Logger.bgPink0.colorRed.log("ERROR: ".concat(msg));
};
var logSuccess = function () {
    ...
    Logger.bgGreen1.log("SUCCESS: ".concat(msg));
};
var logInfo = function () {
    ...
    Logger.bgCyan1.log("INFO: ".concat(msg));
};
var logWarn = function () {
    ...
    Logger.bgOrange1.log("WARN: ".concat(msg));
};
