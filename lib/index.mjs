...
var Exclog = /** @class */ (function () {
    ...
    Exclog.prototype.log = function () {
        ...
        console.log("%c".concat(msg), this._style);
        this._style = INIT_STYLE;
    };
    Exclog.prototype.setPattern = function (pattern) {
        this._patternManager.setPattern(pattern);
    };
    Exclog.prototype.setPatterns = function (patterns) {
        this._patternManager.setPatterns(patterns);
    };
    Exclog.prototype.clearPattern = function () {
        this._patternManager.clear();
    };
    Exclog.Logger = new Proxy(new Exclog(), {
...
var logError = function () {
    ...
    (_a = Logger.bgPink0.colorRed).log.apply(_a, msg);
};
var logSuccess = function () {
    ...
    (_a = Logger.bgGreen1).log.apply(_a, msg);
};
var logInfo = function () {
    ...
    (_a = Logger.bgCyan1).log.apply(_a, msg);
};
var logWarn = function () {
    ...
    (_a = Logger.bgYellow1).log.apply(_a, msg);
};
